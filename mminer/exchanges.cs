    ...
    public partial class exchanges : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                db.update_or_insert("insert into exchanges (name) values ('" + textBox1.Text + "'); ");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            db.update_or_insert("update exchanges set name = '" + textBox1.Text + "' where id = " + id_edit + "; ");
        ...
        private void listView1_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            if (columnindex == 2) //remove
            {
                ...
                {
                    db.update_or_insert("delete from exchanges where id = " + id + "; ");
                    refresh();
                }
            }
            else
