...
namespace EXControls
{
    ...
    public class EXListView : ListView
    {
        ...
        public EXListView()
        {
            ...
            this.SetStyle(ControlStyles.DoubleBuffer | ControlStyles.OptimizedDoubleBuffer, true); //Используем двойной буффер для исчезновения мерцания при обновлении
        ...
        class ListViewSubItemComparerValue : System.Collections.IComparer
        {
            ...
            public int Compare(object x, object y)
            {
                ...
                string xstr = ((EXListViewSubItemAB)((ListViewItem)x).SubItems[_col]).Text;
                string ystr = ((EXListViewSubItemAB)((ListViewItem)y).SubItems[_col]).Text;
